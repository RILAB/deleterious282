...
% Importantly, can we say something abou the difference between inbreds and heterosis? Whitlock 2000 comes back in here, as their theory predicts these should be different SNPs. How much overlap is there? Is it less/more than expected by random?
