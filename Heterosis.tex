...
Furthermore, rare deleterious alleles have gained interest due to their potential role in explaining quantitative trait variation \citep{Gibson2012}, especially in populations that have experienced recent growth \citep{LohmuellerArXiv} .
...
Across all lines, the derived site frequency spectrum (SFS) of coding SNPs showed an excess of rare variants compared to neutral expectations, with 45\% of minor alleles occurring at derived frequencies less than 5\% in the SFS across all lines. 
%I don't quite understand this number. 45% of all minor alleles... but some minor alleles are NOT derived, and thus their derived frequency could be >50%!  Can we phrase it in terms of X% of all SNPs instead?
