...
New mutations may have little consequences for an organism's fitness or be either beneficial or deleterious. Very few mutations are, however, beneficial where a large proportion are likely to be deleterious and are kept at low frequencies by purifying selection \citep{Ohta1973, Kimura1983}. Drift in small populations can, however, meaningfully impact the evolution of such deleterious variants when selection is weak \citep[$s <1/2N_{e}$;][]{Kimura1983}, leading to their fixation as if they were neutral \citep{Lynch1990,Lande1994,Whitlock2003}.

In addition to selection and drift, a number of other factors affect the destiny of deleterious alleles such as the mating system and recombination rate. Selfing species and inbreeding within populations will expose lethal mutations to selection faster than in an outcrossing population \citep{Wang1999,Glemin2003}, but weakly deleterious mutations  can nonetheless be maintained at moderate frequencies, even in the presence of gene flow between populations \citep{Whitlock2000}. Moreover, in genomic regions with low levels of recombination, selection against deleterious mutations will be less effective \citep{Charlesworth1993fp} and the potential exists for deleterious mutations to rise to high frequency due to the effects of linked selection on beneficial mutations \citep{Felsenstein1974, Hill1966, Chun2011}. 
 
Deleterious alleles may play an important role in traits of interest, and complementation between haplotypes carrying different deleterious alleles may explain much of the observation of hybrid vigor or heterosis \citep{Charlesworth2009}. 
In human disease studies, significant correlation was observed between the deleterious predictions of SNPs and their association with cancer \citet{Zhu2004}. Predicted rare deleterious SNPs were also shown to be involved in common diseases \citep{Cohen2004,Smigrodzki2004}. % Cohen2004 for plasma HDL-Cholesterol and Smigrodzki2004 for Parkinson's disease. 
Furthermore, rare alleles, where deleterious ones are over-represented, have gained interest as a non-negligible fraction of loci associated with quantitative traits \citep{Gibson2012}.
Nevertheless, no published studies had yet investigated the effect of deleterious loci on plant traits. 

Evaluating the abundance and frequency of deleterious mutations is thus of considerable interest, and has been investigated in a wide range of species. These analyses have varied in terms of the percentage of non-synonymous sites estimated to be deleterious with, for example, 3.15\, \% of non-synonmous deleterious sites in bacterial populations \citep{Hughes2005}  and 80\, \% of amino acid polymorphisms in Human genome where estimated to be deleterious \citep{Fay2001}. They have also shown that recently bottlenecked populations may have a higher abundance of deleterious sites and that heterozygosity at deleterious SNPs was is lower than at synonymous SNPs \citep{Lohmueller2008}.
Among plants, deleterious variants haven been investigated in detail in only a few cases.  \citet{Tellier2011} estimated to 90\,\% the proportion of non-synonymous SNPs under selection, suggesting that they may be deleterious. \citet{Gunther2010} identified a greater abundance of deleterious variants in genetically divergent populations of \emph{Arabidopsis thaliana},  a result consistent with recent work on local adaptation in that species \citep{Fournier-Level2011}.  \citet{Gunther2010} also find more deleterious variants in domesticated rice than its wild progenitor, a finding that may be explained by these variants being linked to the targets of domestication \citep{Lu2006}. To date, however, studies in plants have not investigated the frequency of deleterious variants among populations, nor the potential for deleterious variants to affect quantitative traits.
...
The transit from heterozygote populations to homozygote, strongly structured heterotic groups, makes maize inbred lines of interest for analyzing the distribution and frequency of deleterious mutations. Furthermore, high observed values of heterosis in maize hybrids makes it a great model for testing the effect of deleterious mutations and their contribution to dominance hypothesis. The latter is one of the classical hypothesis for explaining heterosis and assumes that inbred lines carry homozygote deleterious alleles at different loci that complements in the hybrid, yielding better performances than any of the parents. The two other main hypothesis for heterosis are overdominance and epistasis. The overdominance hypothesis considers heterosis as a per se superiority of heterozygote over both homozygotes at some loci. Epistasis which is the positive interaction between loci do not explain a high portion of genetic variance in comparison to the additive and dominance variances \citep{Schnell1992,Garcia2008}.

The aim of the current study was to make use of the availability of the maize genome sequence, high density single nucleotide polymorphisms (SNPs) and phenotypic data for a large sample of inbred lines and hybrids to (1) carry out a genome wide scan for deleterious mutations, (2) analyze their distribution across the genome and within different genetic groups and (3) test for enrichment of these loci in the results of genome wide association mapping with both the genetic values of inbred lines and hybrid vigor for a number of  quantitative traits. Our results showed that maize inbred lines are segregating for a large number of predicted deleterious variants (20 to 40 \,\% of protein coding SNPs were predicted to have a deleterious allele). These alleles are generally at very low frequencies and there are few deleterious SNPs differentially fixed among different genetic groups. 
Based on results of genome wide association mapping, we find little evidence for enrichment of individual deleterious SNPs. An enrichment for genes containing deleterious SNPs in association results with hybrid vigor was however observed, suggesting a meaningful role for dominance and complementation in explaining observations of hybrid vigor. 
...
\subsubsection*{SNP annotation and anlalyses}
...
Derived site frequency spectrum was calculated for all protein coding SNPs with \emph{Tripsacum} as outgroup. 
Pattern of haplotype sharing across the genome \citep[PHS statistics;][]{Toomajian2006} was analyzed within each of the tropical, stiff-stalk, non-stiff stalk and mixed subpopulations as defined by \citet{Flint-Garcia2005}. We will refer to these subpopulations as ``genetic groups".


\subsubsection*{Phenotypic data analyses}

Genetic values %(average phenotypic value of all individuals with the same genotype)
...
%
where $Y$ is the vector of phenotypic values, $\mu$ is the mean of $Y$, $Z$ is an incidence matrix, $G$ is the vector of fixed individual effects and $\varepsilon$ are the residuals assumed to be $N(0,\sigma _{\varepsilon }^{2}I)$.
...
%
where $\hat{G}$ is the vector of estimated genetic values for inbred lines, $\mu$ is the mean of $\hat{G}$, $M$ is the tested SNP, $\vartheta$ is the SNP effect, $S$ is the structure covariates estimated  with STRUCTURE software \citep{Pritchard2000} by \citet{Flint-Garcia2005}, $\beta$ is the fixed structure effects, $Z$ is an incidence matrix, $u$ is a random effect vector assumed to be $N(0,\sigma_{ {\varepsilon}}^{2}K)$ and $\varepsilon$ are the model residuals assumed to be $N(0,\sigma_{ {\varepsilon}'}^{2}I)$. 
...
\begin{figure*}[!t]
  \begin{center}
   \includegraphics[width=140mm]{PerDelGenome_ch1.jpg}
    \caption{Proportion of genic SNPs predicted to be synonymous, non-deleterious non-synonymous and deleterious non-synonymous in 1Mb windows along chromosome\,1} 
   \label{non_syn_chr1}
  \end{center}
\end{figure*}
%-------------------------------------------------------------------
...
Because most deleterious SNPs are at frequencies too low for inclusion in association analyses (Figure~\ref{sfs_non_syn}), we expanded our test of enrichment to the gene level, asking whether genes with predicted deleterious SNPs were more likely than random to have SNPs significantly associated with traits of interest. At this level we see much stronger evidence of enrichment; a number of traits show statistically significant enrichment in population\,A, but virtually all traits in both populations show a positive enrichment for genes with predicted deleterious SNPs (Tables \ref{gene_enrichment_A} and Supplemental Table \ref{gene_enrichment_B}), a result that is highly unlikely by chance (sign test p-value=$3\ 10^{-5}$ for population\,A and $0.01$ for population\,B). The relatively low correlation between total SNPs in a gene and the number of significant associations ($r\leq 0.2$) suggests that this is not an artifact of the number of SNPs analyzed per gene.  

The observed excess of significant associations in genes with predicted deleterious variants may be due to so-called synthetic associations between rare deleterious loci and a common locus at high enough frequency to be included in association mapping analyses \citep{Dickson2010,Goldstein2009}. Recent work suggests that this sort of association is only likely to hold for deleterious SNPs with a relatively small effect on phenotype \citep{Thornton2013}, which is consistent with the expected weak to intermediate effects of  deleterious loci likely to be involved in heterosis \citep{Charlesworth1987,Whitlock2000,Glemin2003,Charlesworth2009}. Even though, it was shown that rare deleterious SNPs have an effect on human disease \citep{Cohen2004,Smigrodzki2004}. 
...
Although we analyzed only a relatively small subset of the genome-wide diversity \citep{Chia2012}, our data nonetheless present the first genome-wide scan of deleterious coding variants in maize.  Our results provide evidence for the contribution of deleterious mutations to heterosis via complementation, consistent with the dominance hypothesis. 
The weak expected effects of these deleterious loci, combined with their low frequencies, make their detection difficult using the conventional approaches. Accounting, however, \emph{a priori} for the potential effect of these rare polymorphisms may increase predictions of inbred line breeding values and combining ability.

Future analysis of full sequence data, allowing the inclusion of all coding SNPs as well as noncoding variants, will provide an even richer catalog of variants that will expand our understanding of the role rare of deleterious variants in maize breeding.
...
\begin{figure*}[ht]
  \begin{center}
   \includegraphics[width=140mm]{PerDelGenome_ch1cM.jpg}
    \caption{Proportion of genic SNPs predicted to be synonymous, non-deleterious non-synonymous and deleterious non-synonymous in 1\,cM windows along chromosome\,1} 
