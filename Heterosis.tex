...
Pattern of haplotype sharing across the genome (PHS statistics; \citet{Toomajian2006}) was analyzed within each of the tropical, stiff-stalk, non-stiff stalk and mixed subpopulations as defined by \citet{Flint-Garcia2005}. We ail refer to these subpopulations as `genetic groups".
...
Results for association between SNP heterozygosity and heterosis showed highly variable numbers of significant loci (Table \ref{popA_sig_enrichment} and Supplemental Table \ref{popB_sig_enrichment}) also with a high proportion (up to 74\%) of genic SNPs. Significant SNPs explained between 4-40\% of the observed phenotypic variation in heterosis measured for a given traits, though these values are likely inflated due to small sample size \citep{Beavis1994}. The highest number of associated loci were observed for plant height and yield-related traits.%More interpretation here
Most traits exhibited some enrichment ($5-45\%$) of predicted deleterious SNPs, but only for whole plant yield and days to tasseling was the observed enrichment statistically significant. %This could be made into a more positive statementÉafter all it is yield heterosis that was the basis of development of the heterotic groups, so the fact this shows a positive association is both interesting and exciting
