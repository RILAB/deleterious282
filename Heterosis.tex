...
%----------------------------------------
\begin{abstract} 
Most non-synonymous mutations are thought to be deleterious because of their effect on protein \sme{sequence, and are expected to be removed or kept at low frequency by the action of natural selection.} 
...
\sme{In spite of their potential to affect complex trait phenotypes, deleterious alleles are difficult to study precisely because they are often at low frequency.} 
...
The panel structure was previously analyzed \citep{Flint-Garcia2005} and inbred lines were attributed to \sme{the following} subpopulations: \sme{stiff-stalk (27 inbred lines), non stiff-stalk (90 inbred lines), tropicals (60 inbred lines), popcorns (8 inbred lines), sweet (6 inbred lines) and mixed (56 inbred lines)}. For the main temperate inbred lines, these subpopulations corresponds to the different heterotic groups.
...
Genetic values \sme{(the average phenotypic value of all individuals with the same genotype)} of inbreds and hybrids in population B were taken from \citet{Flint-Garcia2009}. 
...
SNPs were deemed to be statistically significant at $p\leq 0.001$. \sme{Analyses were also conducted controlling for a false discovery rate \citep{Benjamini1995} at 20\%.} 
...
Even so, non-synonymous SNPs showed an excess of rare variants when compared to synonymous SNPs (Mann-Whitney U test p-value $<10^{-15}$), and predicted deleterious SNPs showed a marked excess of rare variants compared to both \sme{synonymous and non-deleterious non-synonymous variants (Mann-Whitney U test p-value $<10^{-15}$ for both comparisons; Figure~\ref{sfs_non_syn})}. \sme{The SFS of non-deleterious non-synonymous was not distinguishable from that of synonymous variants (Mann-Whitney U test p-value$=0.07$)}. These observations are consistent with the action of weak purifying selection \citep{Cummings1998,Fay2001} and independent corroboration of the utility of MAPP and SIFT in predicting deleterious variants.
...
\begin{figure*}[!t]
  \begin{center}
   \includegraphics[width=140mm]{PerDelGenome_ch1.jpg}
    \caption{Proportion of genic SNPs predicted to be synonymous, non-synonymous non-deleterious and non-synonymous deleterious in 1\,Mb windows along chromosome\,1.\sme{ The vertical dashed black line indicates the centromere position and blank lines indicate windows with fewer than X SNPs.}}
   \label{non_syn_chr1}
  \end{center}
\end{figure*}
%-------------------------------------------------------------------

The proportion of genic SNPs predicted to be deleterious appeared relatively uniform (Figure \ref{non_syn_chr1} and  Supplemental Figure \ref{non_syn_chr1cM}) across the genome, showing a very low correlation with recombination rate (Pearson's $r$ of 0.06; p-value =$0.005$) \sme{from the IBM (Intermated B73xMo17) genetic map \citep{Gerke2013}}.  Explicit comparison of 1,778 non-synonymous pericentromeric ($\pm$ 5 cM around the functional centromere) SNPs did not show an elevated proportion of predicted deleterious SNPs  in comparison to the whole genome (Fisher's Exact Test p-value $= 0.68$) \sme{and no correlation was observed between gene density and the proportion of predicted deleterious mutation in 1 Megabase windows (Pearson's $r$ of X; p-value =$X$)}. 
...
Individual lines varied considerably in their content of predicted deleterious alleles, carrying between 4 and 16\% of all predicted deleterious alleles. Lines from the stiff stalk group carried on average fewer deleterious mutations (9\%) than did lines from other groups (14-15\%), \sme{even after weighting by the total SNPs in each group (data not shown)}.  Although drift due to a  historically low $N_{e}$ \citep{Messmer1991} could explain this observation, other groups with low $N_{e}$ such as the popcorns do not show such a trend.  Instead, we posit that both the SIFT and MAPP algorithms may be biased against identifying deleterious alleles found in the reference B73 genome.  \sme{ Because B73 is a stiff stalk line abd both programs use the reference allele in identifying deleterious alleles, non-synonmyous SNPs at appreciable frequency in the stiff stalk group may be more likely falsely identified as tolerated.} Similar bias has recently been described in analyses of the human genome \citep{Simons2013}.
...
After allele frequency correction, 287 genes had a predicted deleterious SNP in the top 1\% of Fst among genetic groups, and 30 genes had 2 or more high-Fst predicted deleterious SNPs \sme{(see Figure~\ref{fst_chr1} for chromosome 1)}.  Only eleven genes ($4\%$) with high-Fst deleterious SNPs  are found in regions thought to be selected during maize improvement  \citep{Hufford2012}, however, and only 44 of the 287 genes ($15\%$) show significant signs of positive selection with the PHS statistic. Neither result provides much evidence that selection on linked beneficial mutations strongly impacts frequencies of deleterious alleles.
...
\begin{figure*}[!t]
  \begin{center}
   \includegraphics[width=110mm]{joinSFS.png}
    \caption{Joint site frequency spectrum of stiff-stalk, non stiff-stalk and tropical genetic groups. Axes represent the frequency of the predicted deleterious alleles in a group and colors show the density of SNPs at a given frequency.}
   \label{jfs}
  \end{center}
\end{figure*}
%-------------------------------------------------------------------
...
\begin{table*}[!t]
  \begin{center}
    ...
    \caption[]{Total number of significant SNPs \sme{in genic regions} (\emph{n}) and fold enrichment (\emph{f}) for deleterious SNPs in population A. Numbers marked with ``*'' are statistically significant \sme{(Fisher's exact test p-value$<0.05$)}.}
{\fontsize{10}{10}\sf
...
Furthermore, most traits exhibited some enrichment ($5-45\%$) of predicted deleterious SNPs and the enrichment was statistically significant for whole plant yield and days to tasseling. \sme{These enrichment results hold even after an FDR control at 20\%.}
